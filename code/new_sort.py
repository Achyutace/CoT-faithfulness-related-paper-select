...
def sort_by_X(dimension, kinds, version="v1", csv_prefix = "papers_with_dimensions_", dir_p = DATA_PATH):
    ...
    for kind in kinds:
        ...
        # 保存文件
        file_name = f'2faithfulness_papers_{str(kind).lower()}_{version}.csv'
...
if __name__ == "__main__":
    ...
    sort_by_X("has_phenomenon", ["true", "false"], version="v2", csv_prefix = "filtered_faithfulness_papers_", dir_p=DATA_PATH)